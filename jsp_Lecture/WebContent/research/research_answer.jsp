...
<c:set var="Q_COUNT" value="1"></c:set>
...
<body>
  <header>
    ...
    <form action="ResearchAnswer" method="post">
    <fieldset class="wrapper">
    <legend>${Q_COUNT}번째 질문</legend>
      <ul>
        ...
        <li class="last_li">
	        ...
	        <button type="button" onclick="location.href='research_question.jsp'">질문 재작성</button>
        </li>
        <li><a href="research_main.html">메뉴로 돌아가기</a></li>
      </ul>
    </form>
    </fieldset>
</body>
