...
<body>
  ...
  <div class="wrapper">
    <form action="ResearchCreation" method="post">
      <ul>
        ...
        <li>최대 답변 갯수 : <input class="text-input" type="text" name="MAX_ANUM"></li>
        ...
        <li class="last_li">
        	<button class="return" type="button" onclick="location.href='research_main.html'">뒤로가기</button>
        </li>
